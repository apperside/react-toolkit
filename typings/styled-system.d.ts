...
declare module 'styled-system' {
  ...
  export type ColorKeys = keyof ThemeColors | CSS.Property.Color;
  ...
  export type ThemeRadiiNames = keyof ThemeRadii
  ...
  export type ResponsiveValue<T, TT = T> = T | null | Array<T | null> | { [key in keyof ThemeBreakpoints]?: T };
  ...
  export interface ConfigStyle {
    /** The CSS property to use in the returned style any (overridden by `properties` if present). */
    ...
    /** A string referencing a key in the `theme` any. */
    scale?: string;
    /** A fallback scale any for when there isn't one defined in the `theme` any. */
    defaultScale?: Scale;
  ...
  export interface VariantArgs<TStyle = any, K extends string = string, TPropName = string> {
    key?: string;
  ...
  export function variant<TStyle = any, K extends string = string, TPropName = string>(
    // tslint:disable-next-line no-unnecessary-generics
  ...
  export interface BackgroundColorProps<
    ...
    TVal = (keyof ThemeColors) | NamedColor,
    > {
    /**
     * The color utility parses a component's `color` and `bg` props and converts them into CSS declarations.
     * By default the raw value of the prop is returned.
     ...
     */
    bg?: ResponsiveValue<(keyof ThemeColors) | CSS.Property.Color, ThemeType>;
    backgroundColor?: ResponsiveValue<(keyof ThemeColors) | CSS.Property.Color, ThemeType>
  }
  ...
  export interface FontWeightProps<
     ...
     */
    fontWeight?: ResponsiveValue<TVal | CSS.Property.FontWeight, ThemeType>;
  }
  ...
  export interface MinHeightProps<
    ThemeType extends Theme = RequiredTheme,
    TVal = keyof ThemeSizes | number | string,
    > {
    /**
   ...
   * Flexbox
   */
  export interface AlignItemsProps<ThemeType extends Theme = RequiredTheme, TVal = CSS.Property.AlignItems> {
    /**
     ...
     */
    alignItems?: ResponsiveValue<TVal, ThemeType>;
  }
  ...
  export interface BorderWidthProps<
    ThemeType extends Theme = RequiredTheme,
    TVal = keyof ThemeBorderWidths | number,
    > {
    /**
  ...
  export interface BorderTopProps<
    ThemeType extends Theme = RequiredTheme,
    TVal = keyof ThemeBorders | CSS.Property.BorderTop<TLengthStyledSystem>,
    > {
    /**
  ...
  export interface BorderRightProps<
    ThemeType extends Theme = RequiredTheme,
    TVal = keyof ThemeBorders | CSS.Property.BorderRight<TLengthStyledSystem>,
    > {
    /**
  ...
  export interface BorderBottomProps<
    ThemeType extends Theme = RequiredTheme,
    TVal = keyof ThemeBorders | CSS.Property.BorderBottom<TLengthStyledSystem>,
    > {
    /**
  ...
  export interface BorderLeftProps<
    ThemeType extends Theme = RequiredTheme,
    TVal = keyof ThemeBorders | CSS.Property.BorderLeft<TLengthStyledSystem>,
    > {
    /**
  ...
  export interface BorderRadiusProps<
     ...
     */
    borderRadius?: ResponsiveValue<keyof ThemeRadii | 0 | number | `${number}%`, ThemeType>;
    /**
     * The border-top-left-radius CSS property rounds the top-left corner of an element.
     *
     * [MDN reference](https://developer.mozilla.org/en-US/docs/Web/CSS/border-top-left-radius)
     */
    borderTopLeftRadius?: ResponsiveValue<keyof ThemeRadii | 0 | number | `${number}%`, ThemeType>;
    /**
     * The border-top-right-radius CSS property rounds the top-right corner of an element.
     *
     * [MDN reference](https://developer.mozilla.org/en-US/docs/Web/CSS/border-top-right-radius)
     */
    borderTopRightRadius?: ResponsiveValue<keyof ThemeRadii | 0 | number | `${number}%`, ThemeType>;
    /**
     * The border-bottom-left-radius CSS property rounds the bottom-left corner of an element.
     *
     * [MDN reference](https://developer.mozilla.org/en-US/docs/Web/CSS/border-bottom-left-radius)
     */
    borderBottomLeftRadius?: ResponsiveValue<keyof ThemeRadii | 0 | number | `${number}%`, ThemeType>;
    /**
  ...
  export interface TopProps<
    ThemeType extends Theme = RequiredTheme,
    TVal = keyof ThemeSpaces | 'auto' | number | string,
    > {
    /**
